    ...
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#232323"  text-color="#fff"
                router :default-active="router.currentRoute.value.path">
        ...
        <el-container>
            <!-- 头部区域 -->
            <el-header>
                <div>我的昵称：<strong>{{userInfoStore.info.nickname}}</strong></div>
            ...
            <!-- 底部区域 -->
            <el-footer>大事件 ©2026 Created by 行走的旅人</el-footer>
        </el-container>
    </el-container>
</template>
